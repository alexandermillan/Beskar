...
public class TrapezoidProfileCommand extends CommandBase {
	 ...
	 * {@link TrapezoidProfile}. Output will be piped to the provided consumer
	 * function.
	 *
	 * @param profile
	 *            The motion profile to execute.
	 * @param output
	 *            The consumer for the profile output.
	 * @param requirements
	 *            The subsystems required by this command.
	 */
	public TrapezoidProfileCommand(TrapezoidProfile profile, Consumer<State> output, Subsystem... requirements) {
