...
public class Trigger {
	...
	/**
	 * Creates a new trigger that is always inactive. Useful only as a no-arg
	 * constructor for subclasses that will be overriding {@link Trigger#get()}
	 * anyway.
	 */
	public Trigger() {
		m_isActive = () -> false;
	...
	/**
	 * Composes this trigger with another trigger, returning a new trigger that is
	 * active when both triggers are active.
	 *
	 * @param trigger
	 *            the trigger to compose with
	...
	/**
	 * Composes this trigger with another trigger, returning a new trigger that is
	 * active when either trigger is active.
	 *
	 * @param trigger
	 *            the trigger to compose with
	 ...
	 * acts as the negation of this trigger.
	 *
