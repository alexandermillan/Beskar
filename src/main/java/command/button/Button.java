...
public class Button extends Trigger {
	 ...
	 * {@link Button#get()} is overridden).
	 */
	public Button() {
	}

	/**
	 * Creates a new button with the given condition determining whether it is
	 * pressed.
	 *
	 * @param isPressed
	...
	/**
	 * Starts the given command whenever the button is newly pressed. The command is
	 ...
	 *
	 * {@link Command#schedule(boolean)} will be called repeatedly while the button
	 * is held, and will be canceled when the button is released.
	 *
	 * @param command
	 *            the command to start
	 * @param interruptible
	 ...
	 *
	 * {@link Command#schedule(boolean)} will be called repeatedly while the button
	 * is held, and will be canceled when the button is released. The command is set
	 * to be interruptible.
	 *
	 * @param command
	 *            the command to start
	...
	/**
	 * Starts the given command when the button is first pressed, and cancels it
	 * when it is released, but does not start it again if it ends or is otherwise
	 * interrupted.
	 *
	 * @param command
	 *            the command to start
	 ...
	 * Starts the given command when the button is first pressed, and cancels it
	 * when it is released, but does not start it again if it ends or is otherwise
	 * interrupted. The command is set to be interruptible.
	 *
	 * @param command
	 *            the command to start
	 * @return this button, so calls can be chained
	...
	/**
	 * Starts the command when the button is released. The command is set to be
	 * interruptible.
	 *
	 * @param command
	 *            the command to start
	...
	/**
	 * Toggles the command whenever the button is pressed (on then off then on). The
