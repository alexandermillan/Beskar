...
public class FunctionalCommand extends CommandBase {
	 ...
	 *
	 * @param onInit
	 *            the function to run on command initialization
	 * @param onExecute
	 *            the function to run on command execution
	 * @param onEnd
	 *            the function to run on command end
	 * @param isFinished
	 *            the function that determines whether the command has finished
	 * @param requirements
