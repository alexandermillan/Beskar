...
public class RamseteCommand extends CommandBase {
	 ...
	 * @param wheelSpeeds
	 *            A function that supplies the speeds of the left and right sides of
	 *            the robot drive.
	 ...
	 * @param outputVolts
	 *            A function that consumes the computed left and right outputs (in
	 *            volts) for the robot drive.
	 * @param requirements
	 *            The subsystems to require.
	 */
	@SuppressWarnings("PMD.ExcessiveParameterList")
	public RamseteCommand(Trajectory trajectory, Supplier<Pose2d> pose, RamseteController controller,
	 ...
	 * @param kinematics
	 *            The kinematics for the robot drivetrain.
	 * @param outputMetersPerSecond
	 *            A function that consumes the computed left and right wheel speeds.
	 * @param requirements
	 *            The subsystems to require.
	 */
	public RamseteCommand(Trajectory trajectory, Supplier<Pose2d> pose, RamseteController follower,
